...
if filetype=='cism':
   ...
   if not args.thicknessOnly:
     ...
     fieldInfo['floatingBasalMassBal'] =    {'InputName':'melt', 'scalefactor':910.0/(3600.0*24.0*365.0), 'offset':0.0, 'gridType':'x1', 'vertDim':False}  # Assuming default CISM density
     ...
     # Used by Shiva
     # Below are fields for remapping fields generated by the xr_linregress method - REPLACED! This is a legacy method, to be deleted
     #fieldInfo['draftDepenBasalMeltAlpha0'] = {'InputName':'alpha0', 'scalefactor':1.0, 'offset':0.0, 'gridType':'x1', 'vertDim':False}
     #fieldInfo['draftDepenBasalMeltAlpha1'] = {'InputName':'alpha1', 'scalefactor':1.0, 'offset':0.0, 'gridType':'x1', 'vertDim':False}
     # Used by Shiva
     # Below are fields for remapping fields generated by the scikit-learn LinRegression() method
     fieldInfo['draftDepenBasalMeltAlpha0'] = {'InputName':'draftDepenBasalMeltAlpha0', 'scalefactor':910.0/(3600.0*24.0*365.0), 'offset':0.0, 'gridType':'x1', 'vertDim':False}
     fieldInfo['draftDepenBasalMeltAlpha1'] = {'InputName':'draftDepenBasalMeltAlpha1', 'scalefactor':910.0/(3600.0*24.0*365.0), 'offset':0.0, 'gridType':'x1', 'vertDim':False}
     fieldInfo['draftDepenBasalMelt_paramType'] = {'InputName':'draftDepenBasalMelt_paramType', 'scalefactor':1.0, 'offset':0.0, 'gridType':'x1', 'vertDim':False}
     fieldInfo['draftDepenBasalMelt_constantMeltValue'] = {'InputName':'draftDepenBasalMelt_constantMeltValue', 'scalefactor':910.0/(3600.0*24.0*365.0), 'offset':0.0, 'gridType':'x1', 'vertDim':False}
     fieldInfo['draftDepenBasalMelt_minDraft'] = {'InputName':'draftDepenBasalMelt_minDraft', 'scalefactor':-1.0, 'offset':0.0, 'gridType':'x1', 'vertDim':False}     
     # Below field is for remapping variability and mean of melt from the ocean model output onto the MPAS grid
     fieldInfo['floatingBasalMassBalAdjustment'] = {'InputName':'timeMonthly_avg_landIceFreshwaterFlux', 'scalefactor':1.0, 'offset':0.0, 'gridType':'x1', 'vertDim':False}
