#!/usr/bin/env python3
"""
sorrm_melt_jourdain_regions.py — Welch power spectra of SORRM forcing components.

Reads variability (F_v) and seasonality (F_s) fields, computes domain-mean monthly
time series (memory-safe, chunked), and overlays their spectra. Shows the deterministic
F_s 1-yr spike vs the low-frequency-rich F_v.

For coherence-free per-cell band fractions, use forcing_spectrum_percell.py.
"""
