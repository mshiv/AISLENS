...
RECUTS = [
    ...
    ("S24_surge_maps", f"{CORAL}/reports/chapter4_surge/coral_geoclaw_surge.png",
     (0.0, 0.0, 1.0, 0.545), "GeoClaw surge anomaly, three snapshots"),
    ("S24_surge_validation", f"{CORAL}/reports/chapter4_surge/coral_geoclaw_surge.png",
     (0.0, 0.575, 1.0, 1.0), "modelled surge against the Fort Pulaski record, panel (d)"),
