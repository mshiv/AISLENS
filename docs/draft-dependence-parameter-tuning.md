# Draft Dependence Parameters - Reference for Tuning
...
### Test 3: Very Permissive (Caution!)
...
Expected: ~65-80% linear parameterizations (this can include noisy fits)
...
This typically gives ~55-70% linear parameterizations with acceptable quality for the purposes of AISLENS.